    ...
    return (
        <h1 className="text-5xl font-bold mb-4 flex items-center justify-center gap-3">
            <div className="relative inline-flex items-center">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-violet-500/20 dark:from-blue-600/40 dark:to-violet-600/40 rounded-lg blur-xl" />
                ...
                <span className="relative z-10 ml-3 inline-flex items-center h-12">
                    ...
                    {/* Cursor */}
                    <span className={`inline-block w-0.5 h-10 ml-0.5
