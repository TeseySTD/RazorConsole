            ...
            <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 md:px-6">
                ...
                <div className="flex items-center gap-8">
                    <Link to="/" className="group flex items-center space-x-2">
                        <div
                            className="min-h-[45px] min-w-[45px] animate-shimmer bg-gradient-to-br from-blue-600 via-purple-600 to-purple-800 transition-transform  dark:from-cyan-400 dark:via-purple-500 dark:to-purple-700"
                            style={{
                ...
                <div className="flex items-center gap-3">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="hidden sm:flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50/50 px-3 py-1.5 text-xs font-medium text-slate-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:border-slate-800 dark:bg-slate-900/50 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-slate-50"
                    >
