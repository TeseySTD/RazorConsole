...
function getFilePathForTopic(topicId: string, topics: TopicItem[], releaseNotes: TopicItem[]): string {
...
export default function Docs() {
    ...
    const activeTopic = useMemo(() => (topics.find((topic) => topic.id === activeId) ?? releaseNotes.find((note) => note.id === activeId) ?? topics[0]), [activeId, topics, releaseNotes]);
