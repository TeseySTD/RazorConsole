  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-2">
        <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent dark:from-slate-100 dark:to-slate-400">
          Built-in Components
        </h1>
        ...
        {components.map((component) => (
          <Link
            ...
            className={cn(
              ...
              "hover:border-blue-500/50 hover:shadow-md hover:-translate-y-1",
          ...
          >
            ...
            <div>
              ...
              <h3 className="mb-2 text-lg font-bold font-mono text-slate-900 transition-colors group-hover:text-blue-600 dark:text-slate-100 dark:group-hover:text-blue-400">
                {component.name}
              </h3>
            ...
            <div className="mt-6 flex items-center text-sm font-medium text-blue-600 opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-1 dark:text-blue-400">
              View Details
